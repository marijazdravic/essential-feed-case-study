...
//  EssentialApp
//
//  Created by Marija Zdravic on 26.12.2025..
//
...
extension DispatchQueue {
    static var immediateWhenOnMainQueueScheduler: ImediateWhenOnMainQueueScheduler {
        ImediateWhenOnMainQueueScheduler.shared
    }
    
    struct ImediateWhenOnMainQueueScheduler: Scheduler {
