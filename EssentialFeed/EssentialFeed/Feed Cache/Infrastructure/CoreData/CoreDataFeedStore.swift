...
public final class CoreDataFeedStore: Sendable {
    ...
    @MainActor
    convenience public init(storeURL: URL, contextQueue: ContextQueue = .background) throws {
    ...
    public func perform<T>(_ action: @Sendable @escaping () throws -> T) async rethrows -> T {
