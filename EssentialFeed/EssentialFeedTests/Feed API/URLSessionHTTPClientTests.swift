...
//  EssentialFeedTests
//
//  Created by Marija Zdravic on 21.05.2025..
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failesOnRequestError() {
        ...
        let nsReceivedError = receivedError as? NSError
    ...
    private func anyHTTPURLResponse() -> HTTPURLResponse { return HTTPURLResponse(url: anyURL(), statusCode: 200, httpVersion: nil, headerFields: nil)!
    }
